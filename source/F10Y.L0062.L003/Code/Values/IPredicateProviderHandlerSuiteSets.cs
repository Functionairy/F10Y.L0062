...
{
    [ValuesMarker]
    public partial interface IPredicateProviderHandlerSuiteSets
    {
#pragma warning disable IDE1006 // Naming Styles

        private static IPredicateProviderHandlerSuites _PredicateProviderOperationHandlerSuites => Instances.PredicateProviderSuites;
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        //public For_PredicateProviderSuite.Synchronous.PredicateProviderHandlerSuite<IStringSearchDescriptor, string>[] For_StringSearchDescriptors => new[]
        //{
        ...
        //private static readonly Lazy<Dictionary<Type, For_PredicateProviderSuite.Synchronous.PredicateProviderHandlerSuite<IStringSearchDescriptor, string>>> For_StringSearchDescriptors_ByType_Lazy = new(() =>
        //    Instances.PredicateProviderSuiteSets.For_StringSearchDescriptors
        //        .ToDictionary(x => x.Type)
        //);

        //public Dictionary<Type, For_PredicateProviderSuite.Synchronous.PredicateProviderHandlerSuite<IStringSearchDescriptor, string>> For_StringSearchDescriptors_ByType => For_StringSearchDescriptors_ByType_Lazy.Value;
