...
{
    [FunctionsMarker]
    public partial interface IPredicateHandlerSuiteOperator<THandled, TValue, THandlerSuite> :
        N003.IHandlerSuiteOperator<THandled, THandlerSuite>,
        Synchronous.N001.IPredicateHandlerSuiteOperator<THandled, TValue, THandlerSuite>
        where THandlerSuite : Synchronous.IPredicateHandlerSuite<THandled, TValue>
    {
        bool Evaluate(
            THandled handled,
            TValue value)
